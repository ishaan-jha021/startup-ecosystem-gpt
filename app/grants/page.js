        ...
        <div className="explore">
            <div className="container">
                <div className="explore__header">
                    ...
                    <p>Browse 60+ government and private grants to fuel your startup's growth.</p>
                </div>

                <div className="explore__toolbar">
                    <div className="explore__search">
                        <Search size={16} />
                        <input type="text" placeholder="Search grants..." value={q} onChange={e => setQ(e.target.value)} />
                    </div>
                ...
                {filtered.length === 0 && <p className="text-center text-muted" style={{ padding: 'var(--space-4xl)' }}>No grants match your filters.</p>}
            </div>
